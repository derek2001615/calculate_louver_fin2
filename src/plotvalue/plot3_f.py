...
from val3 import calculate_fanning_friction_factor_values001 as f1
from val3 import calculate_fanning_friction_factor_values002 as f2
from val3 import calculate_fanning_friction_factor_values003 as f3
from val3 import calculate_fanning_friction_factor_values004 as f4
from val3 import calculate_Re_Lp_values as Re_Lp
...
fig1.update_layout(title="Fd=24mm", xaxis_title="Re_Lp", yaxis_title="fanning_friction_factor", template="plotly_dark")

fig1.show()
fig1.write_html("F_d24_f.html")
