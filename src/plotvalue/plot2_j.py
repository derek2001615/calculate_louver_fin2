...
from val2 import calculate_colburn_j_factor_values001 as j1
from val2 import calculate_colburn_j_factor_values002 as j2
from val2 import calculate_colburn_j_factor_values003 as j3
from val2 import calculate_colburn_j_factor_values004 as j4
from val2 import calculate_Re_Lp_values as Re_Lp
...
fig1.update_layout(title="Fd=20mm", xaxis_title="Re_Lp", yaxis_title="colburn_j_factor", template="plotly_dark")

fig1.show()
fig1.write_html("F_d20_j.html")
